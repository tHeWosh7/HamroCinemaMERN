...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50 overflow-hidden '>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex flex-row gap-10 items-center mt-5'>
            <button onClick={()=>{navigate('/')}}className='flex flex-row text-red-500 items-center justify-center bg-white rounded-[5px] w-50 h-10 hover:scale-105 hover:bg-red-500 hover:text-white gap-1'>
              <PlayIcon className='text-red-500 fill-red-500 hover:fill-white hover:text-white' />
              Watch Trailer
              </button>
            <a href="#dateSelect" className='px-10 py-3 text-sm bg-red-500 hover:bg-white hover:text-red-500 transition rounded-md
            ...
            <button className='bg-gray-800/70 p-2.5 rounded-full transition cursor-pointer active:scale-95'>
              <Heart className={`w-5 h-5 hover:scale-110`}/>
            </button>
          </div>
        </div>
      </div>
      ...
      <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='px-10 py-3 text-sm bg-red-500 hover:bg-white hover:text-red-500 transition rounded-md 
